...
},{}],"../../node_modules/form-data/lib/browser.js":[function(require,module,exports) {
...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "C:\\Users\\Natthikan Nui\\Documents\\Test 2",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"manageComponent.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateComponent = exports.createNewComponent = void 0;
...
var createNewComponent = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(datas, route) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "post",
              url: "http://127.0.0.1:8000/api/v1/".concat(route),
              data: datas
            });
  ...
  return function createNewComponent(_x, _x2) {
...
var updateComponent = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(datas, route) {
    var res;
  ...
  return function updateComponent(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.updateComponent = updateComponent;
},{"axios":"../../node_modules/axios/index.js"}],"createNewCore.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createNewCore = void 0;
...
var createNewCore = /*#__PURE__*/function () {
  ...
  return function createNewCore(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.createNewCore = createNewCore;
},{"axios":"../../node_modules/axios/index.js"}],"updateQPoint.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateQPoint = void 0;
...
var updateQPoint = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
  ...
  return function updateQPoint(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateQPoint = updateQPoint;
},{"axios":"../../node_modules/axios/index.js"}],"getCore.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getCores = exports.getCore = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "get",
              url: "http://127.0.0.1:8000/api/v1/core/".concat(id)
            });
...
var getCores = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            console.log("success");
            return _context2.abrupt("return", res.data.data.model);
  ...
  return function getCores() {
    return _ref2.apply(this, arguments);
  };
}();

exports.getCores = getCores;
},{"axios":"../../node_modules/axios/index.js"}],"updateCore.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateCore = void 0;
...
var updateCore = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
...
var _manageComponent = require("./manageComponent");

var _createNewCore = require("./createNewCore");

var _updateQPoint = require("./updateQPoint");

var _getCore = require("./getCore");

var _updateCore = require("./updateCore");
...
//Create New Part
var innerfinform = document.querySelector(".addnewinnnerfintube");
var outerfinform = document.querySelector(".addnewouterfin");
var cupplateform = document.querySelector(".addnewcupplate");
var separatorform = document.querySelector(".addseparator");
var capform = document.querySelector(".addcap");
var jointform = document.querySelector(".addjoint");
var sideplateform = document.getElementById("sideplateform");
var plateheaderform = document.getElementById("plateheaderform");
var tankheaderform = document.getElementById("tankheaderform"); //Create New Core

var coreform = document.querySelector(".createCore"); //Update Component part

var updateInnerfinForm = document.querySelector(".update-component__Innerfintubeform");
var updateOuterFinForm = document.querySelector(".update-component__Outerfinform");
var updateCupPlateForm = document.querySelector(".update-component__Cupplateform");
var updateSeparatorForm = document.querySelector(".update-component__Separatorform");
var updateTankHeaderForm = document.querySelector(".update-component__TankHeaderform");
var updatePlateHeaderForm = document.querySelector(".update-component__PlateHeaderform");
var updateSidePlateForm = document.querySelector(".update-component__SidePlateform");
var updateJointForm = document.querySelector(".update-component__Jointform");
var updateCapForm = document.querySelector(".update-component__Capform"); //Q-point

var qpointForm = document.querySelector(".update-qpoint__form");
var searchCoreBtn = document.getElementById("searchCore");
var searchCoreText = document.getElementById("searchText");
var qpointRender = document.getElementById("qpoint-render");
var renderpartNo = document.getElementById("qpoint-part-no");
var rendermodel = document.getElementById("qpoint-model"); // To Create New Part

if (innerfinform) {
  innerfinform.addEventListener("submit", function (e) {
    e.preventDefault();
    (0, _manageComponent.createNewComponent)(componentForm(innerfinform), "innerfintube");
  });
}

if (outerfinform) {
  outerfinform.addEventListener("submit", function (e) {
    e.preventDefault();
    (0, _manageComponent.createNewComponent)(componentForm(outerfinform), "outerfin");
  });
}

if (cupplateform) {
  cupplateform.addEventListener("submit", function (e) {
    e.preventDefault();
    (0, _manageComponent.createNewComponent)(componentForm(cupplateform), "cupplate");
  });
}
...
if (separatorform) {
  separatorform.addEventListener("submit", function (e) {
    e.preventDefault();
    (0, _manageComponent.createNewComponent)(componentForm(separatorform), "separator");
  });
}
...
if (capform) {
  capform.addEventListener("submit", function (e) {
    e.preventDefault();
    (0, _manageComponent.createNewComponent)(componentForm(capform), "cap");
  });
}

if (jointform) {
  jointform.addEventListener("submit", function (e) {
    e.preventDefault();
    (0, _manageComponent.createNewComponent)(componentForm(jointform), "joint");
  });
}

if (sideplateform) {
  sideplateform.addEventListener("submit", function (e) {
    e.preventDefault();
    (0, _manageComponent.createNewComponent)(componentForm(sideplateform), "sideplate");
  });
}

if (plateheaderform) {
  plateheaderform.addEventListener("submit", function (e) {
    e.preventDefault();
    (0, _manageComponent.createNewComponent)(componentForm(plateheaderform), "plateheader");
  });
}

if (tankheaderform) {
  tankheaderform.addEventListener("submit", function (e) {
    e.preventDefault();
    (0, _manageComponent.createNewComponent)(componentForm(tankheaderform), "tankheader");
  });
}

var componentForm = function componentForm(formElement) {
  var form = new _formData.default(formElement);
...
if (coreform) {
  coreform.addEventListener("submit", function (e) {
    e.preventDefault();
    var form = new _formData.default(coreform);
    form.append("img", document.getElementById("coreImg").files[0]);
    (0, _createNewCore.createNewCore)(form);
  });
}

if (qpointForm) {
  qpointForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var form = new _formData.default(qpointForm);
    form.append("qpoint", document.getElementById("qpoint-file").files[0]);
    (0, _updateQPoint.updateQPoint)(form);
  });
}
...
if (searchCoreBtn) {
  searchCoreBtn.addEventListener("click", function (e) {
    e.preventDefault();
    searchCore();
...
var renderQpoint = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id) {
    var core;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            qpointRender.innerHTML = "";
            qpointRender.insertAdjacentHTML("beforeend", "<img src=\"".concat(core.qpoint.img, "\"  alt=\"qpoint\" class=\"qpoint-viewer__img\"> "));
  ...
  return function renderQpoint(_x) {
    return _ref.apply(this, arguments);
  };
}();

var searchCore = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var cores;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0, _getCore.getCores)();

          case 2:
            cores = _context2.sent;
            cores.map(function (val) {
