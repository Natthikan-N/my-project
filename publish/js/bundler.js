...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"createComponent.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createNewComponent = void 0;
...
},{"axios":"../../node_modules/axios/index.js"}],"componentSelect.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getPart = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log("success");
            return _context.abrupt("return", res.data.data.model);
...
},{"axios":"../../node_modules/axios/index.js"}],"partNo.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.jointPartNo = exports.cupplatePartNo = exports.capPartNo = exports.separatorPartNo = exports.tankheaderPartNo = exports.plateheaderPartNo = exports.sideplatePartNo = exports.outerfinPartNo = exports.innerfintubePartNo = void 0;
var innerfintubePartNo = "447670";
exports.innerfintubePartNo = innerfintubePartNo;
var outerfinPartNo = "447673";
exports.outerfinPartNo = outerfinPartNo;
var sideplatePartNo = "47681";
exports.sideplatePartNo = sideplatePartNo;
var plateheaderPartNo = "47683";
exports.plateheaderPartNo = plateheaderPartNo;
var tankheaderPartNo = "47682";
exports.tankheaderPartNo = tankheaderPartNo;
var separatorPartNo = "47684";
exports.separatorPartNo = separatorPartNo;
var capPartNo = "47685";
exports.capPartNo = capPartNo;
var cupplatePartNo = "47686";
exports.cupplatePartNo = cupplatePartNo;
var jointPartNo = "447687";
exports.jointPartNo = jointPartNo;
...
var _componentSelect = require("./componentSelect");

var _createNewCore = require("./createNewCore");

var _partNo = require("./partNo");
...
console.log("Hello from Mars"); //Create New component
...
var compoform = document.querySelector(".addnewcompo"); //Create New Core

var coreform = document.querySelector(".createCore");
var btnCreateNewCorePage = document.getElementById("btn-creatNewCore"); //Component Select in create core page

var innerfintubelist = document.getElementById("innerfintubelist");
var outerfinlist = document.getElementById("outerfinlist");
var sideplatetoplist = document.getElementById("sideplatetoplist");
var sideplatebuttomlist = document.getElementById("sideplatebuttomlist");
var plateheadertoplist = document.getElementById("plateheadertoplist");
var plateheaderbuttomlist = document.getElementById("plateheaderbuttomlist");
var tankheadertoplist = document.getElementById("tankheadertoplist");
var tankbuttomlist = document.getElementById("tankheaderbuttomlist");
var cupplatelowerlist = document.getElementById("cupplatelowerlist");
var cupplateupperlist = document.getElementById("cupplateupperlist");
var jointlist = document.getElementById("jointlist");
...
if (innerfinform) {
  innerfinform.addEventListener("submit", function (e) {
    ...
    (0, _createComponent.createNewComponent)({
      partNo: partNo,
      length: length
    }, "innerfintube");
  });
...
if (outerfinform) {
  outerfinform.addEventListener("submit", function (e) {
    ...
    var slit = document.getElementById("slit").value;
    (0, _createComponent.createNewComponent)({
      partNo: partNo,
      length: length,
      pitch: pitch,
...
if (compoform) {
  compoform.addEventListener("submit", function (e) {
    e.preventDefault();
    var partNo = document.getElementById("partNo").value;
    var side = document.getElementById("side").value;

    switch (partNo.slice(2).split("-")[0]) {
      case _partNo.sideplatePartNo:
        (0, _createComponent.createNewComponent)({
          partNo: partNo,
          side: side
        }, "sideplate");
      ...
      case _partNo.plateheaderPartNo:
        (0, _createComponent.createNewComponent)({
          partNo: partNo,
          side: side
        }, "plateheader");
...
window.addEventListener("load", function (e) {
  ...
  selectorlist(sideplatebuttomlist, "sideplate"); // selectorlist(sideplatebuttomlist, "sideplate");
...
var selectorlist = function selectorlist(element, route) {
  //clear element and add default value
  element.innerHTML = "";
  element.insertAdjacentHTML("beforeend", "<option value=\"default\">Select Part No</option>"); //add part no in list

  var getPartList = /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0, _componentSelect.getPart)(route);

            case 2:
              part = _context.sent;
              part.map(function (val) {
                element.insertAdjacentHTML("beforeend", "<option value=\"".concat(val.partNo, "\">").concat(val.partNo, "</option>"));
              });
